...
The 5 most popular starting stations for July 2024 are Pier 61 at Chelsea Piers, University Pl & E 14 St, W 21 St & 6 Ave, West St & Chambers St, and W 31 St & 7 Ave.
...
According to above plots, July rides tend to have longer median durations compared to January in both years. Saturday and Sunday have longer median durations compared to weekdays, particularly in July. The median ride duration in 2020 is generally longer than the median ride duration in 2024.


### Create plot shows the impact of month, membership status, and bike type on the distribution of ride duration
...
citi_data |>
  ...
  geom_boxplot() +
  facet_wrap(~month) +
  labs(title = "Impact of Ride Duration by Month, Membership Status and Bike Type",
       x = "Membership Status", 
       y = "Ride Duration") +
  theme_minimal()
```

In July, both casual and member riders tend to have longer ride durations compared to January. Electric bikes have slightly smaller median ride durations compared to classic bikes in most cases. Casual riders have longer ride durations compared to members regardless the bike type or the month. 